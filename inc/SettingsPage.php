...
class SettingsPage {
	...
	public function render_page() {
		...
		<div class="wrap">
			...
			<h2><?php esc_html_e( 'Multisite Feed Settings', 'wp-multisite-feed' ); ?></h2>
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::LANGUAGE_SLUG ?>"><?php _e(
									'RSS Language', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							<input class="regular-text" type="text" value="<?php echo esc_attr(
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::MAX_ENTRIES_PER_SITE ?>"><?php _e(
									'Max. entries per site', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::MAX_ENTRIES ?>"><?php _e(
									'Max. entries overall', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							<input class="regular-text" type="text" value="<?php echo (int) $this->settings->get(
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::EXCLUDED_BLOGS ?>"><?php _e(
									'Exclude blogs', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							<input
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::ONLY_AUTHORS ?>"><?php _e(
									'Include authors', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							<input
					...
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::ONLY_PODCASTS ?>"><?php _e(
									'Only include podcast episodes', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							...
							<p><?php _e(
									'Currently supports podPress or Blubrry PowerPress plugin.', 'wp-multisite-feed'
								) ?></p>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							...
							<p><?php _e( 'For each article in a feed, show full text.', 'wp-multisite-feed' ) ?></p>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							...
							/>
							<p><?php _e( 'For each article in a feed, use the excerpt.', 'wp-multisite-feed' ) ?></p>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
							<label for="inpsmf_<?php echo OptionsKeys::CACHE_EXPIRY ?>"><?php _e(
									'Cache duration in minutes', 'wp-multisite-feed'
								) ?></label>
						</th>
						<td>
							<input class="regular-text" type="text" value="<?php echo (int) $this->settings->get(
							...
							<p><?php _e( 'Set to 0 for deactivate caching.', 'wp-multisite-feed' ) ?></p>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
							<?php _e( 'Your Feed', 'wp-multisite-feed' ) ?>
						</th>
						<td>
